...
class OcrService:
    ...
    def extractText(self, path: str) -> OcrResult:
        ...
        try:
            ...
            return self.parseRawOcrData(rawOcrData, processTime, imgPreData, profile)
